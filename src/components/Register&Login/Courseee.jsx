...
const CourseSchema = Yup.object().shape({
  selectedType: Yup.string().required("Course Type is required"),
          ...
          <form onSubmit={handleSubmit}>
            <FormControl flex="1" mt={4}>
              ...
              {touched.selectedType && errors.selectedType && (
                <Box color="red">{errors.selectedType}</Box>
              )}
            </FormControl>
            ...
            <FormControl flex="1">
              ...
              {touched.selectedCourse && errors.selectedCourse && (
                <Box color="red">{errors.selectedCourse}</Box>
              )}
            </FormControl>
            ...
            <FormControl flex="1">
              ...
              {touched.selectedBranch && errors.selectedBranch && (
                <Box color="red">{errors.selectedBranch}</Box>
              )}
            </FormControl>
